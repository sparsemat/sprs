...
pub fn mat1() -> CsMat<f64> {
    ...
    CsMat::new((5, 5), indptr, indices, data).unwrap()
}
...
pub fn mat1_csc() -> CsMat<f64> {
    ...
    CsMat::new_csc((5, 5), indptr, indices, data).unwrap()
}
...
pub fn mat3() -> CsMat<f64> {
    ...
    let data = vec![3., 4., 2., 5., 5., 8., 7.];
    CsMat::new((5, 4), indptr, indices, data).unwrap()
}
...
pub fn mat5() -> CsMat<f64> {
    ...
    CsMat::new((5, 15), indptr, indices, data).unwrap()
}
