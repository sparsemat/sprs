...
extern "C" {
    ...
    //////////////////          long version           /////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    pub fn ldl_l_symbolic(n: ldl_long,
                          ap: *const ldl_long,
                          ai: *const ldl_long,
                          lp: *mut ldl_long,
                          parent: *mut ldl_long,
    ...
    pub fn ldl_l_numeric(n: ldl_long,
                         ap: *const ldl_long,
                         ai: *const ldl_long,
                         ax: *const ldl_double,
                         lp: *mut ldl_long,
    ...
    pub fn ldl_l_lsolve(n: ldl_long,
                        x: *mut ldl_double,
                        lp: *const ldl_long,
                        li: *const ldl_long,
                        lx: *const ldl_double);

    pub fn ldl_l_dsolve(n: ldl_long,
                        x: *mut ldl_double,
                        d: *const ldl_double);

    pub fn ldl_l_ltsolve(n: ldl_long,
                         x: *mut ldl_double,
                         lp: *const ldl_long,
                         li: *const ldl_long,
                         lx: *const ldl_double);

    pub fn ldl_l_perm(n: ldl_long,
                      x: *mut ldl_double,
                      b: *const ldl_double,
                      p: *const ldl_long);

    pub fn ldl_l_permt(n: ldl_long,
                       x: *mut ldl_double,
                       b: *const ldl_double,
                       p: *const ldl_long);

    pub fn ldl_l_valid_perm(n: ldl_long,
                            p: *const ldl_long,
                            flag: *const ldl_long) -> ldl_long;

    pub fn ldl_l_valid_matrix(n: ldl_long,
                              ap: *const ldl_long,
                              ai: *const ldl_long) -> ldl_long;
}
